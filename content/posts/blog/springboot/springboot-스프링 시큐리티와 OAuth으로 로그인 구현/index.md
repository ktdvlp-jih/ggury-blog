...
1. 글 등록이나, 로그인 버튼 클릭시 구글 로그인 동의 화면으로 이동
   ![구글서비스등록10](/assets/구글서비스등록10.png "구글서비스등록10")
   ![구글서비스등록11](/assets/구글서비스등록11.png "구글서비스등록11")
   ![구글서비스등록12](/assets/구글서비스등록12.png "구글서비스등록12")
2. 그 후 게시판 등록시에는 권한으로 인해 오류가 발생합니다. 이부분은 h2-console에서 권한을 부여해주면 됩니다.
   ![구글서비스등록13](/assets/구글서비스등록13.png "구글서비스등록13")
   ![구글서비스등록14](/assets/구글서비스등록14.png "구글서비스등록14")
   ![구글서비스등록15](/assets/구글서비스등록15.png "구글서비스등록15")
   ![구글서비스등록16](/assets/구글서비스등록16.png "구글서비스등록16")
